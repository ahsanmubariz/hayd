...
const translations = {
  ...
  // ===== Prediction Explainer & Forecast =====
  'predictions.forecast_title': { id: 'Prakiraan Siklus Mendatang', en: 'Upcoming Cycle Forecast' },
  'predictions.next_period_hero': { id: 'Estimasi Menstruasi Berikutnya', en: 'Next Estimated Period' },
  'predictions.in_days': { id: 'dalam %d hari', en: 'in %d days' },
  'predictions.estimated_window': { id: 'Rentang Estimasi', en: 'Estimated Window' },
  'predictions.phase_breakdown': { id: 'Peta Fase & Panduan Ritme', en: 'Phase Map & Rhythm Guide' },
  'predictions.phase_menstrual': { id: 'Fase Menstruasi', en: 'Menstrual Phase' },
  'predictions.phase_menstrual_desc': { id: 'Hari pelepasan alami. Tubuh membutuhkan istirahat lembut, nutrisi hangat, dan hidrasi optimal.', en: 'Natural shedding phase. Body seeks gentle rest, warm nourishment, and optimal hydration.' },
  'predictions.phase_follicular': { id: 'Fase Folikular', en: 'Follicular Phase' },
  'predictions.phase_follicular_desc': { id: 'Estrogen mulai meningkat. Energi, fokus kreatif, dan vitalitas tubuh perlahan bertambah.', en: 'Estrogen rises steadily. Energy, creative focus, and physical vitality steadily build.' },
  'predictions.phase_ovulatory': { id: 'Jendela Subur & Ovulasi', en: 'Fertile Window & Ovulation' },
  'predictions.phase_ovulatory_desc': { id: 'Puncak fertilitas. Sel telur dilepaskan dan hormon mencapai titik tertinggi siklus.', en: 'Peak fertility window. Egg release occurs with peak hormone balance and social vitality.' },
  'predictions.phase_luteal': { id: 'Fase Luteal', en: 'Luteal Phase' },
  'predictions.phase_luteal_desc': { id: 'Progesteron mendominasi. Waktu yang baik untuk refleksi tenang, perawatan diri, dan kenyamanan tubuh.', en: 'Progesterone dominates. Ideal time for restorative care, gentle reflection, and body comfort.' },
  'predictions.confidence_meter': { id: 'Kualitas & Kekuatan Data', en: 'Data Strength & Confidence' },
  'predictions.confidence_low_tip': { id: 'Catat 2-3 siklus lagi untuk membuka akurasi tingkat tinggi.', en: 'Log 2-3 more cycles to unlock high-tier precision.' },
  'predictions.confidence_med_tip': { id: 'Ritme biologis Anda stabil. Prediksi semakin terasah setiap bulan.', en: 'Your biological rhythm is steady. Predictions sharpen with every logged month.' },
  'predictions.how_calculated_title': { id: 'Transparansi Metode Hitung', en: 'Transparent Mathematical Method' },
  'predictions.future_cycles_title': { id: 'Proyeksi 3 Siklus ke Depan', en: 'Projected Next 3 Cycles' },
  'predictions.cycle_n': { id: 'Siklus %d', en: 'Cycle %d' },
  'predictions.recompute_btn': { id: 'Hitung Ulang Estimasi', en: 'Recompute Forecast' },
  ...
  // ===== Calendar Grid & Inspector =====
  'calendar_grid.prev_month': { id: 'Bulan sebelumnya', en: 'Previous month' },
  'calendar_grid.next_month': { id: 'Bulan berikutnya', en: 'Next month' },
  'calendar.today_btn': { id: 'Hari Ini', en: 'Today' },
  'calendar.filter_all': { id: 'Semua', en: 'All' },
  'calendar.filter_period': { id: 'Menstruasi', en: 'Period' },
  'calendar.filter_fertile': { id: 'Masa Subur', en: 'Fertile' },
  'calendar.filter_logs': { id: 'Catatan', en: 'Logs' },
  'calendar.day_details': { id: 'Rincian Hari', en: 'Day Details' },
  'calendar.no_log_for_day': { id: 'Belum ada catatan untuk tanggal ini', en: 'No log recorded for this date' },
  'calendar.tap_to_record': { id: 'Ketuk untuk mencatat kondisi tubuh, suasana hati, atau menstruasi', en: 'Tap to record body status, mood, or bleeding' },
  'calendar.log_for_date': { id: 'Catat / Edit Entri', en: 'Log / Edit Entry' },
  'calendar.mark_period_date': { id: 'Tandai Menstruasi', en: 'Log Period' },
  'calendar.cycle_day_n': { id: 'Hari Siklus %d', en: 'Cycle Day %d' },
  'calendar.period_day_n': { id: 'Menstruasi Hari %d', en: 'Period Day %d' },
  'calendar.month_summary': { id: 'Ringkasan Ritme', en: 'Rhythm Summary' },
  'calendar.period_days_count': { id: '%d hari menstruasi', en: '%d period days' },
  'calendar.logs_count': { id: '%d catatan harian', en: '%d daily logs' },
